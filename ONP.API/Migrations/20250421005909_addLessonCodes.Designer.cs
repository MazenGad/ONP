...
namespace ONP.API.Migrations
{
    ...
    [Migration("20250421005909_addLessonCodes")]
    partial class addLessonCodes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ONP.API.Entity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ONP.API.Entity.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ONP.API.Entity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ONP.API.Entity.CodeSnippet", b =>
                {
                    b.HasOne("ONP.API.Entity.ApplicationUser", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("ONP.API.Entity.Course", b =>
                {
                    b.HasOne("ONP.API.Entity.Category", "Category")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("ONP.API.Entity.CourseProgress", b =>
                {
                    b.HasOne("ONP.API.Entity.CourseContent", "Content")
                        .WithMany()
